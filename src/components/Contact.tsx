...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "info@greenpacargentina.com",
      ...
      <div className="greenpac-container">
        <div className="text-center mb-16">
          ...
          <p className="text-primary-foreground/70 text-lg max-w-2xl mx-auto">
            Estamos listos para asesorarte y encontrar la solución perfecta
            para las necesidades de tu establecimiento.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="pt-6 border-t border-primary-foreground/10">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="https://www.facebook.com/greenpac.argentina"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-primary-foreground/10 hover:bg-primary/30 flex items-center justify-center transition-colors"
                >
          ...
          <form
            ...
            className="lg:col-span-3 bg-primary-foreground/5 rounded-2xl p-8"
          >
            ...
            <div className="mb-5">
              <label htmlFor="phone" className="block text-primary-foreground/80 text-sm font-medium mb-2">
                Teléfono
              </label>
              <Input
                id="phone"
