          ...
          >
            <div className={`animate-slide-up flex flex-col items-start sm:${itemsClass(h1Align).replace('items-', '')} space-y-2 sm:space-y-5 lg:space-y-7`}>
              ...
              <div className="flex items-center gap-2 sm:gap-2.5 w-fit">
                ...
                <p className="text-primary font-semibold <p className="text-primary font-semibold text-[10px] sm:text-[clamp(0.85rem,1.1vw,1rem)] tracking-[0.15em] sm:tracking-[0.25em] uppercase whitespace-nowrap"> uppercase whitespace-nowrap">
                  {kicker}
                </p>
              </div>
