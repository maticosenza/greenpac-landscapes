...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center sm:justify-center greenpac-container pb-20 sm:pb-20 lg:pb-24 pt-20 sm:pt-32" style={{ minHeight: "100svh" }}>
