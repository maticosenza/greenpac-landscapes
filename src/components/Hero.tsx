          ...
          >
            <div className={`animate-slide-up flex flex-col items-start sm:${itemsClass(h1Align).replace('items-', '')} space-y-2 sm:space-y-5 lg:space-y-7`}>
              ...
              <div className="w-full relative">
                ...
                <h1 className={`text-primary-foreground font-extrabold leading-[1.08] tracking-tight <h1 className={`text-primary-foreground font-extrabold leading-[1.08] tracking-tight text-[38px] sm:text-[3.2rem] md:text-[3.8rem] lg:text-[clamp(3rem,4.6vw,5.1rem)] drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] sm:drop-shadow-none text-left sm:${alignClass(h1Align).replace('text-', '')}`}> md:text-[3.8rem] lg:text-[clamp(3rem,4.6vw,5.1rem)] drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] sm:drop-shadow-none text-left sm:${alignClass(h1Align).replace('text-', '')}`}>
              ...
              <div className="flex sm:hidden flex-col items-stretch gap-2 pt-3 w-full">
                <a
                  href="#cotizacion"
                  className="flex items-center justify-center h-[42px] rounded-lg border-2 border-white/80 text-white bg-transparent hover:bg-white/10 font-display font-semibold text-[13px] transition-all duration-300"
                >
                  {ctaQuote}
                </a>
